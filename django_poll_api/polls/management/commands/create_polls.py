    ...
    dict(
        ...
        questions=[
            {"question_text": "Как звали 44 президента США", "question_type": "text"},
            {
                ...
                "choices": ["Авраам Линкольн", "Барак Обама", "Рональд Рейган", "Джордж Вашингтон"],
            },
            {
                "question_text": "Кто из президентов США жил в 20 веке",
                "question_type": "multiple_choice",
                "choices": ["Франклин Рузвельт", "Рональд Рейган", "Гарри Трумэн", "Джон Тайлер", "Джеймс Монро"],
            },
        ],
    ),
    dict(
        ...
        questions=[
            {
                ...
                "question_type": "choice",
                "choices": ["Авраам Линкольн", "Рональд Рейган", "Герман Титов", "Нил Армстронг"],
            },
            {"question_text": "Самый мощный космический телескоп", "question_type": "text"},
            {
            ...
            for quest_data in questions:
                ...
                if choices:
                    for choice_content in choices:
                        PollQuestionChoice.objects.create(content=choice_content, question=question)
